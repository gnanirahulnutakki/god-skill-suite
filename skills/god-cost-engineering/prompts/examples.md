...
> "We are encountering a critical failure. Using the `god-cost-engineering` protocol, analyze this stack trace and log output. Deduce the root cause. If you lack information, state exactly what logs or metrics you need to pinpoint the issue instead of guessing."
